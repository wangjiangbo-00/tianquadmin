...
class Album extends BaseService implements IAlbum
{
    ...
    public function getAlbumClassDefaultCount($shopid){
        $album_class = new AlbumClassModel();
        $count = $album_class->getCount(["shop_id"=>$shopid,"is_default"=>1]);
        return $count;
    }
    ...
    public function addCloudPicture($pic_name, $pic_tag, $aclass_id, $pic_cover, $pic_size, $instance_id = 0)
    {
        // TODO Auto-generated method stub
        $data = array(
            'shop_id' => $instance_id,

...
class Express extends BaseService implements IExpress
{
    ...
    public function getShippingFeeList($page_index = 1, $page_size = 0, $condition = '', $order = '')
    {
        ...
        foreach ($list['data'] as $k => $v) {
            $address = new Address();
            $list['data'][$k]['address_list'] = $address->getAddressListById($v['province_id_array'], "");
        }
        return $list;
    }
     ...
     */
    public function addShippingFee( $is_default, $shipping_fee_name, $province_id_array, $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $free_mode)
    {
        ...
        try {
            ...
            $redis->lpush("apicheck.getshopfeelist", $this->instance_id);
            return 1;
        } catch (\Exception $e) {
     ...
     */
    public function updateShippingFee($shipping_fee_id, $is_default, $shipping_fee_name, $province_id_array,  $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $free_mode)
    {
        $order_shipping_fee = new NsOrderShippingFeeModel();
     ...
     */
    public function getExpressCompanyProvincesAndCitiesById($shop_id, $current_province_id_array, $current_city_id_array)
    {

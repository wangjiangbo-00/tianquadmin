...
class Promotion extends BaseService implements IPromotion
{
    ...
    public function getSuperGroupList($page_index = 1, $page_size = 0, $condition = '', $order = 'create_time desc')
    {
        $promotion_group = new NsGroupModel();
        $list = $promotion_group->pageQuery($page_index, $page_size, $condition, $order, '*');
    ...
    public function getRecomendCodeList($page_index = 1, $page_size = 0, $condition = '', $order = 'id desc')
    {
        $promotion_gift = new NsRecommendCodeModel();
        $list = $promotion_gift->pageQuery($page_index, $page_size, $condition, $order, '*');
    ...
    public function getPromotionGroupList($page_index = 1, $page_size = 0, $condition = '', $order = 'create_time desc')
    {
        $promotion = new NsGroupModel();
        $list = $promotion->pageQuery($page_index, $page_size, $condition, $order, '*');
     ...
     */
    public function addPromotionGift($shop_id, $gift_name, $start_time, $end_time, $days, $max_num, $goods_id,$shopname,$remarks,$mode,$parms)
    {
        ...
        try {
            ...
            $goods_info = $goods->getInfo([
                'goods_id' => $goods_id
            ], 'goods_name,picture,price,bannerurl');


            if($mode == 2 || $mode == 3)
            {
                $chance = $parms;
                $solution = rand(0,$chance);
            ...
            $data_gift = array(
                ...
                'max_num' => $max_num,
                'ownername' => $shopname,
                'ownerpic' => $shop["shop_logo"],
                'create_time' => date("Y-m-d H:i:s", time()),
                'remarks' => $remarks,
                'goods_id' => $goods_id,
                'goods_name' => $goods_info['goods_name'],
                'goods_picture' => $goods_info['bannerurl'],
     ...
     */
    public function updatePromotionGift($gift_id, $shop_id, $gift_name, $start_time, $end_time, $days, $max_num,$goods_id ,$remarks,$mode,$parms)
    {
        $promotion_gift = new NsPromotionGiftModel();
        $promotion_gift->startTrans();
        try {
    ...
    public function deleteGift($gift_id)
    {
        ...
        try
        {
            ...
            $promotion_gift->destroy($gift_id);
     ...
     */
    public function addPromotiondiscount($discount_name, $start_time, $end_time, $remark, $goods_id_array,$pid,$type,$level)
    {
    ...
    public function addPromotionGroup($discount_name, $start_time, $end_time, $goods_id,$stage_format,$require_num)
    {
        $promotion_discount = new NsGroupModel();
        $promotion_discount->startTrans();
        try {
            ...
            $promotion_discount->save($data);
            $discount_id = $promotion_discount->group_order_id;
    ...
    public function updatePromotionGroup($id,$discount_name, $start_time, $end_time, $goods_id,$stage_format,$require_num)
    {
        $promotion_discount = new NsGroupModel();
        $promotion_discount->startTrans();
        try {
            ...
            $promotion_discount->save($data,["group_order_id"=>$id]);
    ...
    public function addPromotionActivity($discount_name, $start_time, $end_time, $description, $type,$pic,$is_visible,$is_open,$sort)
    {
        $promotion_discount = new NsPromotionDiscountModel();
        $promotion_discount->startTrans();
        try {
            ...
            $platfrom_activity = new NsPlatformActivityModel();
    ...
    public function updatePromotionActivity($id, $description,$pic,$is_visible,$is_open,$sort)
    {
        $promotion_discount = new NsPromotionDiscountModel();
        $promotion_discount->startTrans();
        try {
    ...
    public function updatePromotionDiscount($discount_id, $discount_name, $start_time, $end_time, $remark, $goods_id_array)
    {
        ...
        try {
            ...
            $discount = $this->getPromotionDiscountDetail($discount_id);
    ...
    public function updatePlatfromPromotionDiscount($discount_id, $goods_id_array)
    {
        $promotion_discount = new NsPromotionDiscountModel();
        $promotion_discount->startTrans();
        try {
            ...
            foreach ($goods_id_array as $k => $v) {
                ...
                $discount_info = explode(':', $v);
                $goods_discount = new GoodsDiscount();
                $count = $goods_discount->getGoodsIsDiscount($discount_info[0], $info["start_time"], $info["end_time"]);
                // 查询商品名称图片
                if ($count > 0) {
                    $promotion_discount->rollback();
                    return ACTIVE_REPRET;
    ...
    public function getPromotionGroupDetail($id)
    {
        $promotion_discount = new NsGroupModel();
        $promotion_detail = $promotion_discount->get($id);

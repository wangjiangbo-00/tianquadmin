...
class NsMemberFavoritesModel extends BaseModel {
    protected $table = 'zytc_member_favorites';
    protected $rule = [
        'log_id'  =>  '',
    ];
    protected $msg = [
    ...
    public function getGoodsFavouitesViewQuery($page_index, $page_size, $condition, $order)
    {
        ...
        ->join('zytc_goods ng',"nmf.fav_id = ng.goods_id","left")
        ->join('zytc_goods_category ngc','ng.category_id = ngc.category_id','left')
        ->join('zytc_goods_brand ngb','ng.brand_id = ngb.brand_id','left')
    ...
    {
        $viewObj = $this->alias('nmf')
        ->join('zytc_shop ns',"nmf.fav_id = ns.shop_id","left")

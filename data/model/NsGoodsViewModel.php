...
class NsGoodsViewModel extends BaseModel
{
    ...
    public function getGoodsViewQuery($page_index, $page_size, $condition, $order)
    {
        $viewObj = $this->alias('ng')
            ...
            ->field('ng.goods_id, ng.goods_name, ng.shop_id, ng.category_id, 
               ng.price, ng.group_price, ng.stock,  
              ng.picture, ng.introduction, ng.pictureurl,ng.bannerurl,ng.type,
            ng.description, ng.code, ng.is_recommend, 
              ng.state, ng.create_time, 

...
interface IPromotion
{
    ...
    */
     ...
     */
    function addPromotionGift($shop_id, $gift_name, $start_time, $end_time, $days, $max_num, $goods_id_array,$shopname,$remarks,$mode,$parms);
    /**
     * 修改赠品活动
     ...
     * @param unknown $goods_id_array
     */
    function updatePromotionGift($gift_id, $shop_id, $gift_name, $start_time, $end_time, $days, $max_num, $goods_id,$remarks,$mode,$parms);
    /**
     * 获取赠品详情
     * @param unknown $gift_id
     */
     ...
     */
    function addPromotiondiscount($discount_name, $start_time, $end_time, $remark, $goods_id_array,$pid,$type,$level);
    /**
     * 修改限时折扣

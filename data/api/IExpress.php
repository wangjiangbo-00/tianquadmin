...
interface IExpress
{
     ...
     */
    function addShippingFee( $is_default, $shipping_fee_name, $province_id_array, $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $free_mode);
     ...
     */
    function updateShippingFee($shipping_fee_id, $is_default, $shipping_fee_name, $province_id_array, $weight_snum, $weight_sprice, $weight_xnum, $weight_xprice, $free_mode);
